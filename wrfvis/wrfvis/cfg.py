...
# wrfout = r'C:\Users\Johanna Schramm\OneDrive - uibk.ac.at\Scientific Programming\Project\wrfvis\ffff\WRF_output_project.nc'
wrfout = "C:/Users/lenaz/Desktop/MA_1_Semester/Programming/Unit8/wrfvis_all/wrfvis/WRF_output_project.nc"


# location of data directory
pkgdir = os.path.dirname(__file__)
html_template = os.path.join(pkgdir, 'data', 'template.html')
html_template_cross = os.path.join(pkgdir, 'data', 'template_cross.html')
...
test_map = os.path.join(pkgdir, 'data', 'test_map.txt')
